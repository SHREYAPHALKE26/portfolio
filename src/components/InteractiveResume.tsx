...
import { Download, Eye, X, FileText, Star } from 'lucide-react';
...
const InteractiveResume: React.FC = () => {
  ...
  const resumeData = {
    ...
    summary: 'Passionate B.Tech Information Technology student at VIT Pune with expertise in Python, Flask, Machine Learning, and Web Development. Experienced in building efficient applications and leading technical teams.',
    skills: {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-8 space-y-8">
              {/* Render the Resume Preview content here */}
              {/* You can keep the previous resumeData rendering logic unchanged */}
            </div>
          </div>
        </div>
      )}
